...
const (
	batchPath  = "/github.com/example-owner/example-repository/info/lfs/objects/batch"
	verifyPath = "/github.com/example-owner/example-repository/info/lfs/objects/verify"
)
